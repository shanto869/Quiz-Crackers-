                ...
                <div className="accordion-item">
                    ...
                    <div id="flush-collapseOne" className="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                        ...
                        <div className="accordion-body">
                            <p>
                                <PaperAirplaneIcon className='arrow me-2'></PaperAirplaneIcon>
                                React Router is a standard library for routing in React. It enables the navigation among views of various components in a React Application, allows changing the browser URL, and keeps the UI in sync with the URL. It maintains the standard structure and behavior of the application and mainly used for developing single page web applications.
                            </p>
                            <p>
                                <PaperAirplaneIcon className='arrow me-2'></PaperAirplaneIcon>
                ...
                <div className="accordion-item">
                    ...
                    <div id="flush-collapseTwo" className="accordion-collapse collapse" aria-labelledby="flush-headingTwo"
                        ...
                        <div className="accordion-body">
                            ...
                            <p>
                                <PaperAirplaneIcon className='arrow me-2'></PaperAirplaneIcon>
                                For this, React.createContext() is all you need. It returns a consumer and a provider. Provider is a component that as it's names suggests provides the state to its children. It will hold the "store" and be the parent of all the components that might need that store. Consumer as it so happens is a component that consumes and uses the state.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="accordion-item">
                    ...
                    <div id="flush-collapseThree" className="accordion-collapse collapse" aria-labelledby="flush-headingThree"
                        ...
                        <div className="accordion-body">
                            ...
                            <p>
                                <PaperAirplaneIcon className='arrow me-2'></PaperAirplaneIcon>
                                If we tried to count how many times our application renders using the useState Hook, we would be caught in an infinite loop since this Hook itself causes a re-render.To avoid this, we can use the useRef Hook.</p>
                        </div>
                    </div>
                </div>
            </div>
